...
class CursoController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Periodo', 'Personalplantel']
        ];
    ...
    public function view($id = null)
    {
        $curso = $this->Curso->get($id, [
            'contain' => ['Periodo', 'Personalplantel', 'Requisicion']
        ]);
    ...
    public function add()
    {
        ...
        $periodo = $this->Curso->Periodo->find('list', ['limit' => 200]);
        $personalplantel = $this->Curso->Personalplantel->find('list', ['limit' => 200]);
        $this->set(compact('curso', 'periodo', 'personalplantel'));
    }
